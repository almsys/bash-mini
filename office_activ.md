...
3. Создайте в ручную задание в планировщике и задайте ТРИГГЕР - событие в журнале ПРИЛОЖЕНИЯ c ID 1003. Далее там же укажите ДЕЙСТВИЯ запуска bat файла который снизу.
